...
var UserStore = /** @class */ (function () {
    ...
    UserStore.prototype.create = function (u) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, pepper, saltRounds, hashedPassword, result, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'INSERT INTO users (id, first_name, last_name, user_password) VALUES($1, $2, $3, $4) RETURNING *';
                        pepper = process.env.BCRYPT_PEPPER;
                        saltRounds = process.env.SALT_ROUNDS;
                        hashedPassword = bcrypt_1["default"].hashSync(u.user_password + pepper, parseInt(saltRounds));
                        return [4 /*yield*/, conn.query(sql, [u.id, u.first_name, u.last_name, hashedPassword])];
                    case 2:
                        result = _a.sent();
                        conn.release();
                        return [2 /*return*/, result.rows[0]];
